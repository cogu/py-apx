/* Test has been autogenerated by py-apx generator 0.4.0 */
...
//////////////////////////////////////////////////////////////////////////////
#define APX_DEFINITON_LEN 450u
#define APX_IN_PORT_DATA_LEN 25u
...
#define APX_RX_LEN_SOUNDREQUEST2 3u
...
#define APX_RX_OFFSET_SOUNDREQUEST2 21u
#define APX_RX_OFFSET_RU8LASTPORT 24u
...
static const uint8_t m_inPortInitData[APX_IN_PORT_DATA_LEN]= {
   12, 255, 127, 1, 0, 0, 0, 1, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 210
};
...
"APX/1.2\n"
"N\"Test\"\n"
"T\"LightRequest_T\"{\"LightId\"S\"Intensity\"C}\n"
...
"R\"LightRequest\"T[0]:={65535,255}\n"
"R\"SoundRequest\"T[1]:={65535,255}\n"
"R\"SoundRequest2\"T[1]:={65535,255}\n"
"R\"RU8LastPort\"C:=210\n"
"\n";
...
void Test_inPortDataWritten(void *arg, apx_nodeData_t *nodeData, uint32_t offset, uint32_t len)
{
   ...
   while (offset < endOffset)
   {
      ...
      case APX_RX_OFFSET_SOUNDREQUEST:
         ...
         break;
      //case APX_RX_OFFSET_SOUNDREQUEST2:
