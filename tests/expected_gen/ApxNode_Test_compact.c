/* Test_compact has been autogenerated by py-apx generator 0.4.1 */
...
#include <string.h>
#include <stdio.h>
#include "ApxNode_Test_compact.h"
#include "ApxNode_Test_compact_Cbk.h"
#include "pack.h"

//////////////////////////////////////////////////////////////////////////////
// CONSTANTS AND DATA TYPES
//////////////////////////////////////////////////////////////////////////////
#define APX_DEFINITON_LEN 488u
...
"APX/1.2\n"
"N\"Test_compact\"\n"
"P\"SoundRequestAck\"{\"SoundId\"S\"Volume\"C}:={65535,255}\n"
"P\"HapticRequest\"{\"HapticId\"S\"Intensity\"C}:={65535,255}\n"
"P\"PS8ARPort\"c[1]:={1}\n"
"P\"PS8Port\"c:=0\n"
...
"R\"LightRequest\"{\"LightId\"S\"Intensity\"C}:={65535,255}\n"
"R\"SoundRequest\"{\"SoundId\"S\"Volume\"C}:={65535,255}\n"
"R\"RU8LastPort\"C:=210\n"
"\n";
...
apx_nodeData_t * ApxNode_Init_Test_compact(void)
{
   ...
   apx_nodeData_create(&m_nodeData, "Test_compact", (uint8_t*) &m_apxDefinitionData[0], APX_DEFINITON_LEN, &m_inPortdata[0], &m_inPortSyncedFlags[0], APX_IN_PORT_DATA_LEN, &m_outPortdata[0], &m_outPortDirtyFlags[0], APX_OUT_PORT_DATA_LEN);
   memset(&nodeDataHandler, 0, sizeof(nodeDataHandler));
   nodeDataHandler.inPortDataWritten = Test_compact_inPortDataWritten;
...
void Test_compact_inPortDataWritten(void *arg, apx_nodeData_t *nodeData, uint32_t offset, uint32_t len)
{
   ...
   while (offset < endOffset)
   {
      ...
      case APX_RX_OFFSET_RS16ARPORT:
         (void) ApxNode_Read_Test_compact_RS16ARPort(&data.RS16ARPort[0]);
      ...
      case APX_RX_OFFSET_RU8PORT:
         (void) ApxNode_Read_Test_compact_RU8Port(&data.RU8Port);
      ...
      case APX_RX_OFFSET_SOUNDREQUEST:
         (void) ApxNode_Read_Test_compact_SoundRequest(&data.SoundRequest);
