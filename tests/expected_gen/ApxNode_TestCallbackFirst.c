/* TestCallbackFirst has been autogenerated by py-apx generator 0.4.1 */
...
apx_nodeData_t * ApxNode_Init_TestCallbackFirst(void)
{
   ...
   apx_nodeData_create(&m_nodeData, "TestCallbackFirst", (uint8_t*) &m_apxDefinitionData[0], APX_DEFINITON_LEN, &m_inPortdata[0], &m_inPortSyncedFlags[0], APX_IN_PORT_DATA_LEN, 0, 0, 0);
   memset(&nodeDataHandler, 0, sizeof(nodeDataHandler));
   nodeDataHandler.inPortDataWritten = TestCallbackFirst_inPortDataWritten;
