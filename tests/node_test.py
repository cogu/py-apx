...
def _create_autosar_workspace():
    ...
    dataTypes.createBooleanDataType('TestBool_T')
    ...
    constants.createConstant('C_TestBool_IV', 'TestBool_T', True)
    ...
    portInterfaces.createSenderReceiverInterface('TestBool_I', autosar.DataElement('TestBool', 'TestBool_T'))
    ...
    swc.createRequirePort('TestBool', 'TestBool_I', initValueRef = constants['C_TestBool_IV'].ref)
